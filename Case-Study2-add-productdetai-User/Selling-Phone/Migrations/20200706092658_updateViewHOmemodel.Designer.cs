...
namespace Selling_Phone.Migrations
{
    ...
    [Migration("20200706092658_updateViewHOmemodel")]
    partial class updateViewHOmemodel
    {
            ...
            modelBuilder.Entity("Selling_Phone.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            OrderDate = new DateTime(2020, 7, 6, 16, 26, 57, 746, DateTimeKind.Local).AddTicks(28),
                            ShipAddress = "28 NTP",
                            ShipName = "Hiệp",
                            Status = 0,
