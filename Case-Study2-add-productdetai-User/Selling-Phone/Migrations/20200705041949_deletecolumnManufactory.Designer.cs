...
namespace Selling_Phone.Migrations
{
    ...
    [Migration("20200705041949_deletecolumnManufactory")]
    partial class deletecolumnManufactory
    {
            ...
            modelBuilder.Entity("Selling_Phone.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            OrderDate = new DateTime(2020, 7, 5, 11, 19, 48, 411, DateTimeKind.Local).AddTicks(5708),
                            ShipAddress = "28 NTP",
                            ShipName = "Hiệp",
                            Status = 0,
